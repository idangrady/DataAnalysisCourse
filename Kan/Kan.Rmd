...
write.csv(id.df,"D:\\BLOCK4\\HCI\\R\\0524\\test.csv", row.names = FALSE)
ttest.data <- read_csv("test.csv")
avg_very_active.avg_fall_asleep.lm <- lm(avg_fall_asleep ~ avg_very_active , data =ttest.data)
summary(avg_very_active.avg_fall_asleep.lm)
avg_steps.avg_fall_asleep.lm <- lm( avg_fall_asleep ~ avg_steps, data =ttest.data)
summary(avg_steps.avg_fall_asleep.lm)
library(ggpubr)
ggscatter(ttest.data, x = "avg_steps", y = "avg_fall_asleep", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "avg_very_active", ylab = "avg_fall_asleep")
